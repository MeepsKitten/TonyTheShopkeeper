...
export default {
    ...
    computed: {
        allPerkNames() {
            ...
            const perkNames = [];
            if (this.perksData && this.perksData.gmods && this.perksData.gmods.pools) {
                for (const perksByRarity of Object.values(this.perksData.gmods.pools)) {
    ...
    methods: {
        ...
        scrollToPerk(perkName) {
            ...
            let panelIndex = -1;
            let poolName = '';
            const pools = this.perksData.gmods.pools;
